...
import { ChevronLeft, ChevronRight, Loader2, Pencil, PiggyBank, RefreshCw } from 'lucide-react';
...
export const PersonalBudgetView = ({ onViewSyncedExpense, theme = 'dark' }) => {
    ...
    return (
        <section className="space-y-5">
            ...
            <div key={`${monthKey}-content`} className={`space-y-5 ${monthAnimClass}`}>
                {/* Hero stats */}
                ...
                <div className="grid gap-4 lg:grid-cols-2 items-start">
                    {[
                        ...
                        { section: 'tracked_expense', splitSync: true },
                        { section: 'saving', splitSync: false },
                        { section: 'debt', splitSync: false },
                    ].map(({ section, splitSync }, index) => (
                        <div
                            key={section}
